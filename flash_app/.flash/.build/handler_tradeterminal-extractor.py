"""
Auto-generated deployed handler for resource: tradeterminal-extractor
...
extract = importlib.import_module('main').extract
...
def handler(job):
    ...
    try:
        ...
        _logger.error(
            "Deployed handler error for extract: %s",
            e,
            exc_info=True,
        )
