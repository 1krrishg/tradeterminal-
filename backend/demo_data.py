"""
Pre-cached demo results for hackathon demo.
Key: f"{product.lower()}_{origin.lower()}_{destination.lower()}"
"""
    ...
    "spices_nepal_india": {
        ...
        "compliance": {
            ...
            "required_documents": [
                ...
                {"name": "Bill of Lading / Airway Bill", "confidence": 0.97, "source": "https://www.cbic.gov.in/"},
            ...
            "restrictions": [
                {"description": "Pesticide residue must comply with FSSAI MRL limits — tested at port of entry", "confidence": 0.93, "source": "https://www.fssai.gov.in/upload/uploadfiles/files/Compendium_Pesticide.pdf"},
            ...
            "labeling_requirements": [
                ...
                {"description": "Importer name and address on label", "confidence": 0.94, "source": "https://www.fssai.gov.in/"},
            ],
            "common_rejection_reasons": [
                ...
                "Non-compliant packaging — moisture ingress issues",
            ],
            "recent_regulation_changes": [
                {
                    "description": "FSSAI tightened MRL limits for 50 pesticides in spices effective Jan 2025",
                    "date": "January 2025",
                    "source": "https://www.fssai.gov.in/"
                },
                {
                    "description": "India-Nepal Trade Treaty revised — 30% basic customs duty applies; SAFTA preferential rate available at 0% for eligible exporters",
                    "date": "March 2024",
        ...
        "market": {
            ...
            "sentiment_summary": "Indian consumers strongly prefer whole spices over ground, citing freshness and adulteration concerns. Nepali mountain-origin spices (especially cardamom, timur pepper, and turmeric) command a 15–25% premium on BigBasket and Amazon.in due to perceived purity.",
            "top_complaints": [
        ...
        "shipping": {
            "carrier": "Trucking via Raxaul-Birgunj border crossing",
            "estimated_cost_usd": 180,
            "transit_days": "2–4 days",
            "raw": "Land route Nepal-India border crossing estimate",
        },
        "landed_cost": {
        ...
        "margin_gap_usd": 504,
        "margin_gap_label": "Profitable — strong margin if you target premium segment (mountain-origin, whole spices)",
        "data_source": "Bright Data scraped: BigBasket.com, Amazon.in · Regulations: fssai.gov.in, cbic.gov.in · Shipping: Freightos land estimate · AI: Qwen3.5-2B on Runpod Flash",
        "cached": True,
    },
    ...
    "textiles_bangladesh_germany": {
        ...
        "compliance": {
            ...
            "certifications": [
                ...
                {"name": "GOTS (Global Organic Textile Standard) if organic", "confidence": 0.75, "source": "https://global-standard.org/"},
            ],
            "restrictions": [
            ...
            "labeling_requirements": [
                ...
                {"description": "Fibre composition must be stated (EU Textile Regulation 1007/2011)", "confidence": 0.99, "source": "https://ec.europa.eu/"},
            ...
            "import_fees_and_taxes": [
                ...
                {"name": "GSP reduced rate (if EUR.1 issued)", "estimated_amount": "0%"},
            ],
        },
        "market": {
            ...
            "top_complaints": [
                ...
                "Slow delivery compared to EU suppliers",
            ],
        },
        "shipping": {
            "carrier": "Hapag-Lloyd / MSC (sea freight, Chittagong → Hamburg)",
            "estimated_cost_usd": 1200,
            "transit_days": "18–22 days",
            "raw": "Freightos: Chittagong → Hamburg sea freight",
        },
        "landed_cost": {
        ...
        "data_source": "Bright Data scraped: Zalando.de, Otto.de · Regulations: ec.europa.eu, echa.europa.eu, zoll.de · Shipping: Freightos sea freight · AI: Qwen3.5-2B on Runpod Flash",
        "cached": True,
    },
    ...
    "coffee_ethiopia_japan": {
        ...
        "compliance": {
            ...
            "required_documents": [
                ...
                {"name": "Import Notification (Ministry of Health form)", "confidence": 0.91, "source": "https://www.mhlw.go.jp/"},
            ...
            "certifications": [
                ...
                {"name": "Rainforest Alliance / Fairtrade (strong market advantage)", "confidence": 0.80, "source": "https://www.rainforest-alliance.org/"},
            ],
            "restrictions": [
                {"description": "Pesticide residue must comply with Japan positive list system — 799 regulated substances", "confidence": 0.95, "source": "https://www.mhlw.go.jp/"},
                {"description": "Ochratoxin A (mycotoxin) limits apply to all coffee", "confidence": 0.90, "source": "https://www.mhlw.go.jp/"},
            ],
            "labeling_requirements": [
            ...
            "common_rejection_reasons": [
                ...
                "Mycotoxin (ochratoxin A) above 10 ppb",
                "Incomplete or incorrect phytosanitary documentation",
        ...
        "market": {
            "local_avg_price": "¥3,200/250g bag",
            "local_price_range": "¥800–¥8,500/250g",
            "seller_count": 3100,
            "competition_level": "medium",
            "consumer_sentiment": "positive",
            "sentiment_summary": "Japanese specialty coffee market is booming. Ethiopian single-origin (especially Yirgacheffe and Sidamo) commands strong premium on Rakuten and Amazon.co.jp. Third-wave coffee culture drives demand for natural process and washed varieties with clear origin stories.",
            "top_complaints": [
                "Freshness — long shipping time from Ethiopia impacts aroma",
                "Price premium vs Brazilian or Vietnamese coffee",
                "Inconsistent roast profiles from smaller exporters",
            ],
        },
        "shipping": {
            "carrier": "Evergreen / ONE (sea freight, Djibouti → Osaka)",
            "estimated_cost_usd": 890,
            "transit_days": "22–28 days",
            "raw": "Freightos: Djibouti → Osaka sea freight estimate",
        },
        "landed_cost": {
        ...
        "margin_gap_usd": 1890,
        "margin_gap_label": "Strong margin — Ethiopian specialty coffee premium in Japan is substantial. Focus on single-origin story and JAS organic certification for max price.",
        "data_source": "Bright Data scraped: Rakuten.co.jp, Amazon.co.jp · Regulations: customs.go.jp, mhlw.go.jp · Shipping: Freightos sea freight · AI: Qwen3.5-2B on Runpod Flash",
        "cached": True,
    },
}


def get_demo(product: str, origin: str, destination: str):
    key = f"{product.lower()}_{origin.lower()}_{destination.lower()}"
    return DEMO_CACHE.get(key)
